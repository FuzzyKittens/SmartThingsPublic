...
metadata {
	...
	definition (name: "fk Z-Wave Somfy Remote", namespace: "fuzzykittens", author: "ericvitale@gmail.com") {
    ...
    tiles(scale: 2) {
        ...
        valueTile("NumberOfButtons", "device.numberOfButtons", width: 6, height: 2) {
        	state "default", label: 'This damn remote has ${currentValue} buttons.'
        }
